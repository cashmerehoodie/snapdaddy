      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <DialogTitle className="text-xl">Google Sign-In Consent</DialogTitle>
          </div>
          <DialogDescription className="text-left">
            SnapDaddy is requesting access to sign you in with Google. Here's what we'll access:
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-3 p-3 rounded-lg bg-secondary/50 border border-border/50">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">To create and identify your account</p>
                </div>
              </div>
          ...
          <div className="rounded-lg bg-green-500/10 border border-green-500/20 p-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-green-700 dark:text-green-400">Your data is protected</p>
                <p className="text-xs text-muted-foreground">
                  We only use this information to authenticate you. We never share your data with third parties.
                </p>
              </div>
            </div>
          </div>
